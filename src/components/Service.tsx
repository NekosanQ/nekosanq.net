              ...
              <div className="md:mb-20 md:w-2/3 max-w-xl text-center md:text-start">
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-2 mt-5" aria-label={`${title}の実績`}>
                  {achievements.map(({ label, value }) => (
                    <div
                      key={label}
                      className="min-w-32 rounded-lg border border-white/10 border-l-2 border-l-emerald-400 bg-gradient-to-r from-white/10 to-white/[0.03] px-4 py-2.5 text-left shadow-sm backdrop-blur-sm"
                    >
