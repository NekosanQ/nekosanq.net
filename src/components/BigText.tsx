...
const BigText: React.FC = () => {
  ...
  return (
    <div className="text-center md:text-left mt-40 ml-0 md:ml-96 font-bold relative">
      <h1 className="text-5xl bg-gradient-to-t from-slate-200 via-lime-100 to-slate-200 bg-clip-text text-transparent drop-shadow-[0_0_5px_rgba(255,255,255,0.6)]">
